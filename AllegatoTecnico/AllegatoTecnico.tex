...
\newpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{sez/RequisitiDiSistema.tex}
\newpage
\input{sez/InstallazioneEdEsecuzione.tex}
\newpage
\input{sez/RapportoPoC.tex}
\newpage
\input{sez/ArchitetturaProdotto.tex}
\newpage
\input{sez/SoddisfacimentoRequisiti.tex}
\pagebreak
\input{sez/UCSoddisfatti.tex}
