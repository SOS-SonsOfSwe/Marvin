...
Lo scopo del prodotto è quello di realizzare un \emph{prototipo}\ped{G} di Uniweb come una \emph{DApp}\ped{G} in esecuzione su \emph{Ethereum}\ped{G}. I cinque attori principali che si rapportano con Marvin sono:
\begin{itemize}
