...
\begin{itemize}
	\item \textbf{Attori}: Metamask, Utente non autenticato;
	\item \textbf{Descrizione}: Il sistema logga automaticamente l'attore se ha una sessione Metamask attiva e valida;
...
\begin{itemize}
	...
	\end{itemize}
	\item \textbf{Postcondizione}:È stato aggiunto un anno accademico o si è verificato un errore di inserimento.
\end{itemize}
...
\begin{itemize}
	...
	\end{itemize}
	\item \textbf{Postcondizione}: È stato aggiunto un corso di laurea o si è verificato un errore di inserimento.
\end{itemize}
...
\begin{itemize}
	...
	\end{itemize}
	\item \textbf{Postcondizione}: È stata aggiunta un'attività didattica o si è verificato un errore di inserimento.
...
\begin{itemize}
	...
	\end{itemize}
	\item \textbf{Postcondizione}: È stato aggiunto un esame o si è verificato un errore di inserimento.
...
\begin{itemize}
	...
	\end{itemize}
	\item \textbf{Postcondizione}: Il sistema disiscrive l'attore a quell'esame o l'operazione viene annullata.
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Postcondizione}: Il sistema non disiscrive l'attore a quell'esame in quanto esso ha annullato l'operazione.
...
\begin{itemize}
	...
	\end{itemize}
	\item \textbf{Postcondizione}: È stato aggiunto un utente o si è verificato un errore di inserimento.
...
\begin{itemize}
	\item \textbf{Attori}: Amministratore, Università;
	\item \textbf{Descrizione}: L'attore può rimuovere un utente, cancellando i dati ad esso associati nonché rimuovendone l'accesso al sistema;
