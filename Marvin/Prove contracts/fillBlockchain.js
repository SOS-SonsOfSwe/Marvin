       ...
       .then(() => {
        StudentContract.deployed()
          .then(async studentInstance => {
			...
			await studentInstance.subscribeExam('APP2', { from: address7 })
              .then(() => console.log('Line ' + line++ + ' ok'))
              .catch(() => console.error('Error at line ' + line++));
            await studentInstance.subscribeExam('APP2', { from: address8 })
              .then(() => console.log('Line ' + line++ + ' ok'))
              .catch(() => console.error('Error at line ' + line++));
            await studentInstance.subscribeExam('APP2', { from: address9 })
              .then(() => console.log('Line ' + line++ + ' ok'))
              .catch(() => console.error('Error at line ' + line++));
			  
			
			await studentInstance.subscribeExam('APP3', { from: address7 })
              .then(() => console.log('Line ' + line++ + ' ok'))
              .catch(() => console.error('Error at line ' + line++));
            await studentInstance.subscribeExam('APP3', { from: address8 })
              .then(() => console.log('Line ' + line++ + ' ok'))
              .catch(() => console.error('Error at line ' + line++));
            await studentInstance.subscribeExam('APP3', { from: address9 })
              .then(() => console.log('Line ' + line++ + ' ok'))
              .catch(() => console.error('Error at line ' + line++));
          })
          ...
          .then(() => {
            TeacherContract.deployed()
              .then(async teacherInstance => {
				...
				await teacherInstance.registerResult('APP2', '7', '30', { from: address4 })
                  .then(() => console.log('Line ' + line++ + ' ok'))
                  .catch(() => console.error('Error at line ' + line++));
                await teacherInstance.registerResult('APP2', '8', '20', { from: address4 })
                  .then(() => console.log('Line ' + line++ + ' ok'))
                  .catch(() => console.error('Error at line ' + line++));
                await teacherInstance.registerResult('APP2', '9', '18', { from: address4 })
                  .then(() => console.log('Line ' + line++ + ' ok'))
                  .catch(() => console.error('Error at line ' + line++));
				  
				await teacherInstance.registerResult('APP3', '7', '30', { from: address4 })
                  .then(() => console.log('Line ' + line++ + ' ok'))
                  .catch(() => console.error('Error at line ' + line++));
                await teacherInstance.registerResult('APP3', '8', '20', { from: address4 })
                  .then(() => console.log('Line ' + line++ + ' ok'))
                  .catch(() => console.error('Error at line ' + line++));
                await teacherInstance.registerResult('APP3', '9', '18', { from: address4 })
                  .then(() => console.log('Line ' + line++ + ' ok'))
                  .catch(() => console.error('Error at line ' + line++));
              })
              .then(() => {
                StudentContract.deployed()
                  .then(async studentInstance => {
                    await studentInstance.confirmResult('APP1', { from: address7 })
                      .then(() => console.log('Confirm 1'))
                      .catch(() => console.error('Error at line ' + line++));
                    await studentInstance.confirmResult('APP1', { from: address8 })
                      .then(() => console.log('Confirm 2'))
                      .catch(() => console.error('Error at line ' + line++));
                    await studentInstance.confirmResult('APP1', { from: address9 })
                      .then(() => console.log('Confirm 3'))
                      .catch(() => console.error('Error at line ' + line++));
					  
					await studentInstance.confirmResult('APP2', { from: address7 })
                      .then(() => console.log('Confirm 4'))
                      .catch(() => console.error('Error at line ' + line++));
                    await studentInstance.confirmResult('APP2', { from: address8 })
                      .then(() => console.log('Confirm 5'))
                      .catch(() => console.error('Error at line ' + line++));
                    await studentInstance.confirmResult('APP2', { from: address9 })
                      .then(() => console.log('Confirm 6'))
                      .catch(() => console.error('Error at line ' + line++));
					  
					await studentInstance.confirmResult('APP3', { from: address7 })
                      .then(() => console.log('Confirm 4'))
                      .catch(() => console.error('Error at line ' + line++));
                    await studentInstance.confirmResult('APP3', { from: address8 })
                      .then(() => console.log('Confirm 5'))
                      .catch(() => console.error('Error at line ' + line++));
                    await studentInstance.confirmResult('APP3', { from: address9 })
                      .then(() => console.log('Confirm 6'))
                      .catch(() => console.error('Error at line ' + line++));
                  })
