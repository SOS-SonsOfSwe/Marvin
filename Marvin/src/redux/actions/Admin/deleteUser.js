...
import { ADMINS as req } from '../../reducers/costants/adminCostants'
...
export function deleteUserFromDatabase(badgeNumber) {
      ...
      web3.eth.getCoinbase((error, coinbase) => {
        ...
        admin.deployed()
          .then(function (instance) {
            ...
            adminInstance.removeUser(parseInt(badgeNumber, 10), { from: coinbase })
              .then(() => {
              ...
              .finally(() => { return browserHistory.back() })
          })
      })
      // })
      // })
