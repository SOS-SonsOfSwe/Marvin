...
const readAdminsReducer = (state = initialState, action) => {
  if(action.request === adminCostants.ADMINS) {
    switch(action.type) {
    ...
    case adminCostants.ERASE_ADMINS:
      {
        return {
          ...state,
          payload: null,
...
export default readAdminsReducer