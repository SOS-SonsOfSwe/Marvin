import { costCostants, userCostants } from './costants'
...
const costReducer = (state = initialState, action) => {
  if (action.request === costCostants.COSTS) {
    switch (action.type) {
      ...
      case userCostants.FETCH_DATA_SUCCESS:
        {
          console.log('adminReducer: successfully fetched prices data')
      ...
      case costCostants.ERASE_COST_REDUCER:
        {
          return {
            ...state,
            payload: null,
