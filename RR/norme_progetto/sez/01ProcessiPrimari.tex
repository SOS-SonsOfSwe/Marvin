...
\paragraph{Progettazione}
	...
	~\\La progettazione ha come scopo quello di soddisfare le peculiarità identificate durante l'\AdR. Un altro obiettivo è quello di realizzare un prodotto \emph{manutenibile}\ped{G} ovvero, un prodotto che abbia una struttura in grado di facilitare i cambiamenti futuri.
