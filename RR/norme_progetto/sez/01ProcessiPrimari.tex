...
\begin{itemize}
	...
	~\\ Il gruppo ha scelto \emph{SWEgo} come database per la gestione dei casi d'uso, dei requisiti, del loro tracciamento e dei diagrammi UML per l'analisi dei requisiti. Dopo un'attenta analisi preliminare dello strumento infatti, il team ha deciso di affidarsi ad esso nonostante alcuni problemi rilevati nella generazione del codice \LaTeX{} perché permette una stesura standardizzata e sempre aggiornata, a fronte di correzioni minori.
\end{itemize}	
