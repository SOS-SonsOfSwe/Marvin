...
\end{comment}
	...
	\subsubsection{Strumenti}
		...
		Per avere traccia di tutte le modifiche realizzate sui documenti e sul codice prodotti, il team ha deciso di utilizzare \emph{GitHub}, creando una repository. Si seguiranno le norme dscritte qui di seguito.
			\paragraph{Struttura}
			\begin{itemize}
