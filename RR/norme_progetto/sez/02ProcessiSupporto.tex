...
\end{itemize}
	...
	Il \emph{versionamento\ped{G}} permette a ciascun membro del team di condividere il lavoro nello spazio comune e di lavorare su vecchi e nuovi \emph{CI}\ped{G} \emph{\textcolor{red}{Configuration Item}} senza rischio di sovrascritture accidentali.
	\\Avrà questa forma:
	\begin{center}
		\emph{vX.Y.Z}
	\end{center}
	...
	\subsubsection{Strumenti}
			\paragraph{\textbf{\emph{\LaTeX}}}\ped{G}
...
%\begin{comment}
	...
	\begin{itemize}
		...
		\item 
		\emph{\textbf{\emph{W3C Markup Validator Service}}}\ped{G}\footnote{\href{https://jigsaw.w3.org/css-validator/}{https://jigsaw.w3.org/css-validator/}}
