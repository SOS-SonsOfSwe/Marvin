...
W3C offre uno strumento per valutare le pagine \emph{HTML}\ped{G} e uno per i i fogli di stle \emph{CSS}\ped{G}, come dichiarato nelle \NdP{}: essi riportano il numero e il tipo di errori trovati nei documenti in esame.

\subparagraph{Soglie}
	\begin{itemize}
	\item Accettabilità: saranno accettati file HTML e CSS ciascuno con un numero di errori minore o uguale a 5. In relazione alla dimensione finale del progetto, si darà anche un limite al numero totale degli errori come somma degli errori di tutti i file; si prevedono inoltre modifiche del limite di 5 errori rilevati (aumento o diminuzione) in corso d'opera;
