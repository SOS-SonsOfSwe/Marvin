...
\begin{itemize}
	...
	\item Tool di \textit{data visualization}\ped{G} o \textbf{\textit{HTML5}}\ped{G}, \textbf{\textit{CSS3}}\ped{G} e \textbf{JavaScript} per l'interfaccia di visualizzazione; viene consigliato \textbf{\textit{Bootstrap}}\ped{G} come \textit{framework}\ped{G} \textit{responsive}\ped{G}.
\end{itemize}
