...
\begin{itemize}
	...
	\item \textbf{\textit{Proponente}}\ped{G}: SIAV
	\item \textbf{\textit{Committente}}\ped{G}: Tullio Vardanega, Riccardo Cardin
\end{itemize}
...
\begin{itemize}
	...
	\item sistema di \textbf{\textit{Identity and Access Management}}\ped{G} \textbf{\textit{Keycloak}}\ped{G} per l'autenticazione degli utenti;
	\item \textbf{\textit{Apache Nutch}}\ped{G} per il \textbf{\textit{web scraping}}\ped{G}.
\end{itemize}
