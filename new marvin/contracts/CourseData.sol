...
contract CourseData {
    ...
    function getCourseExamsData(bytes10 _courseUniCode) public view returns(bytes32[], uint32[], bool[], bytes10[]) {
        ...
        return(examsHashCodes, teachers, areActives, examsForCourse);
    }
