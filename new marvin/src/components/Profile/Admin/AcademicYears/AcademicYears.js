...
class AcademicYears extends React.Component {
    ...
    render() {
        ...
        const empty = this.props.empty ? < EmptyData label = 'no data found on blockchain' / > : < div / >
          ...
          return( <
            div > { load } { empty } { /* executing this field only if the loading is false. Pay attention to the exact value: avoid doing "something !== false", instead use "something===true" as "null" is a third value */ } {
              ...
              to = "/profile/academic-years/insert-academic-year" > Insert academic year < /Link> <
                /button> <
                /div> {
                  this.props.empty === false && this.props.success === true &&
                    ...
                    /tr> <
                    /thead> <
                    tbody > { /* {console.log('this.props.data.load: ' + this.props.data)} */ } { /* {console.log('component: AcademicYear. Data: this.props.data: ' + JSON.stringify(this.props.data))} */ } {
