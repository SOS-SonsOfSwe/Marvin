...
class ModifyClass extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            degree: 'to mare',  /*INSERIRE IL CORSO DI LAUREA*/
            class: 'omo',  /*INSERIRE L'ATTIVITà DIDATTICA CHE L'UTENTE HA DECISO DI MODIFICARE*/
        ...
        return (
            <main className='container'>
                <div className="pure-u-1-1">
                    <h1>Modify Class</h1>
                    <p>Now you can modify this Class.</p>
                    <form className="pure-form pure-form-stacked">
                        <fieldset>
                            ...
                            <label>Class</label>
                            <input type="text" value={this.state.class} onChange={this.handleChange2} />
                            <label>Exam</label>
