...
export function deleteCourseFromDatabase(courseUnicode) {
      ...
      web3.eth.getCoinbase((error, coinbase) => {
        ...
        admin.deployed()
          .then(function (instance) {
            ...
            adminInstance.removeCourse(courseUnicode, { from: coinbase })
              .then(() => {
                return doAwesomeStuff(dispatch, courseUnicode) //Repeating because of the asyncronous promises of the functions
              })
              .catch(error => {
              ...
              .finally(() => { return browserHistory.push('/profile/courses') })
          })
      })
    }
  } else {
