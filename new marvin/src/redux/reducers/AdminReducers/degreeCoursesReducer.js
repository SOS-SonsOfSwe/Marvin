...
const degreeCoursesReducer = (state = initialState, action) => {
  if(action.request === adminCostants.DEGREE_COURSES) {
    ...
    case adminCostants.FETCH_DATA_SUCCESS:
      {
        console.log('adminReducer: successfully fetched degree courses data')
    ...
    case adminCostants.DELETED_DATA:
      {
        console.log('adminReducer: successfully deleted degree course')
...
export default degreeCoursesReducer